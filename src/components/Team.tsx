  ...
  return (
    <section id="team" className="min-h-screen py-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-10 left-10 text-[#B0903B] text-8xl">♓</div>
        <div className="absolute top-1/3 right-10 text-[#B0903B] text-7xl">♑</div>
        <div className="absolute bottom-20 left-1/4 text-[#B0903B] text-6xl">♊</div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <h3 className="text-3xl font-bold text-[#DEA193] text-center mb-8 tracking-wide">Core Team</h3>
            ...
            {coreTeam.map((member, idx) => (
              ...
              >
                ...
                <div className="h-32 flex items-center justify-center mb-4">
                  <div className="w-24 h-24 rounded-full bg-[#B0903B]/20 border-2 border-[#B0903B] flex items-center justify-center group-hover:border-[#DEA193] transition-colors">
                    <Crown className="w-12 h-12 text-[#B0903B] group-hover:text-[#DEA193] transition-colors" />
                  </div>
                </div>

                <div className="text-center">
                  <p className="text-sm text-[#B0903B] uppercase tracking-widest mb-2">{member.role}</p>
        ...
        <div className="mb-16">
          <h3 className="text-3xl font-bold text-[#DEA193] text-center mb-8 tracking-wide">Coordinators</h3>
        ...
        <div className="mb-16">
          <h3 className="text-3xl font-bold text-[#DEA193] text-center mb-8 tracking-wide">Rookie Members</h3>
          <div className="bg-[#380A2D]/50 backdrop-blur-sm border-2 border-[#B0903B]/50 rounded-lg p-8">
        ...
        <div>
          <h3 className="text-3xl font-bold text-[#DEA193] text-center mb-8 tracking-wide">Faculty Support</h3>
          <div className="bg-[#380A2D]/50 backdrop-blur-sm border-2 border-[#B0903B]/50 rounded-lg p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="border-l-4 border-[#B0903B] pl-4">
                <p className="text-[#B0903B] text-sm uppercase tracking-wider mb-1">College Secretary</p>
                <p className="text-[#DEA193] font-bold">{faculty.secretary}</p>
              </div>
              <div className="border-l-4 border-[#B0903B] pl-4">
                <p className="text-[#B0903B] text-sm uppercase tracking-wider mb-1">Principal</p>
                <p className="text-[#DEA193] font-bold">{faculty.principal}</p>
              </div>
              <div className="border-l-4 border-[#B0903B] pl-4">
                <p className="text-[#B0903B] text-sm uppercase tracking-wider mb-1">Convener</p>
                <p className="text-[#DEA193] font-bold">{faculty.convener}</p>
              </div>
              <div className="border-l-4 border-[#B0903B] pl-4">
                <p className="text-[#B0903B] text-sm uppercase tracking-wider mb-1">Program Officer</p>
                <p className="text-[#DEA193] font-bold">{faculty.programOfficer}</p>
              </div>
            </div>
            <div className="border-t border-[#B0903B]/30 pt-6">
              <p className="text-[#B0903B] text-sm uppercase tracking-wider mb-4">Faculty Coordinators</p>
        ...
        >
          ...
          >
            ...
            <div className="text-center mb-6">
              <div className="text-7xl text-[#B0903B]/30 mb-4">{selectedMember.zodiac}</div>
              <p className="text-sm text-[#B0903B] uppercase tracking-widest mb-2">{selectedMember.role}</p>
              <h2 className="text-4xl font-bold text-[#DEA193] mb-6">{selectedMember.name}</h2>
            </div>

            <div className="border-t border-b border-[#B0903B]/30 py-6">
              <p className="text-[#DEA193]/90 leading-relaxed text-center">{selectedMember.bio}</p>
            </div>
          </div>
        </div>
      )}
